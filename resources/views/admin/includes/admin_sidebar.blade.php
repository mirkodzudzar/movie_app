<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="{{Auth::user()->photo ? Auth::user()->photo->file : App\Photo::noPhoto()}}" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
        <!-- Change this later -->
        <a href="{{ route('admin.users.edit', Auth::user()->id) }}" class="d-block">{{ Auth::user()->username }}</a>
      </div>
    </div>
